    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your fleet drivers and assignments.</p>
        </div>
      ...
      <div className="bg-card rounded-sm border border-border shadow-sm flex flex-col">
        ...
        <div className="p-16 flex flex-col items-center justify-center text-center">
          ...
          <h3 className="text-sm font-medium text-foreground">No drivers found</h3>
          <p className="text-[13px] text-muted-foreground mt-1 mb-4 max-w-sm">Driver profiles and status will appear here.</p>
        </div>
      </div>
    </div>
  );
